...
export default function FormValidation() {
 ...
 return(
    ...
    <form onSubmit={handleSubmit(onSubmitForm)}>
        ...
        {errors.price && <div style={err}>กำหนดราคาสินค้าตัวเลขที่มากกว่า 0</div>}
    </div>
            <div className="form-group mb-3">
        ...
        <div className="form-group mb-3">
            ...
            <input type="date" id="dateAdded" name="dateAddded"
            className="form-control form-control-sm"/>
        </div>
        <div className="form-group mb-3">
            <label htmlFor="file" className="form-label">ภาพสินค้า *(ไม่เกิน 3 ไฟล์ ขนาดสูงสุด 300KB/ไฟล๋)</label>
